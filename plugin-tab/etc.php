...
if ( ! function_exists ( 'oxsn_sitemap_plugin_nav_item' ) ) {

	add_action('admin_menu', 'oxsn_sitemap_plugin_nav_item', 99);
	function oxsn_sitemap_plugin_nav_item() {

		add_submenu_page('oxsn-dashboard', 'Oxsn Sitemap', 'Sitemap', 'manage_options', 'oxsn-sitemap', 'oxsn_sitemap_plugin');

	}

}

if ( !function_exists('oxsn_sitemap_plugin') ) {

	function oxsn_sitemap_plugin() {
